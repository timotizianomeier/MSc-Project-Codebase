...
from study_assistant_v2.utils import (
    parse_args,
    setup_logger,
    handle_vision_stuff,
...
def run(
    ...
    from study_assistant_v2.moves import MovementManager
    from study_assistant_v2.console import LocalStream
    from study_assistant_v2.openai_realtime import OpenaiRealtimeHandler
    from study_assistant_v2.tools.core_tools import ToolDependencies
    from study_assistant_v2.audio.head_wobbler import HeadWobbler
    ...
    if args.gradio:
        ...
        from study_assistant_v2.gradio_personality import PersonalityUI
...
class StudyAssistantV2(ReachyMiniApp):  # type: ignore[misc]
