...
from study_assistant_v1.config import LOCKED_PROFILE, config
from study_assistant_v1.openai_realtime import OpenaiRealtimeHandler
from study_assistant_v1.headless_personality_ui import mount_personality_routes
...
class LocalStream:
    ...
    def _persist_api_key(self, key: str) -> None:
        ...
        - Writes/updates ``<instance_path>/.env``:
          ...
          * Else, copies template from ``<instance_path>/.env.example`` when present,
            ...
            ``study_assistant_v1/.env.example``.
    ...
    def _persist_personality(self, profile: Optional[str]) -> None:
        ...
        try:
            from study_assistant_v1.config import set_custom_profile
    ...
    def _init_settings_ui_if_needed(self) -> None:
        ...
        def _ready() -> JSONResponse:
            try:
                mod = sys.modules.get("study_assistant_v1.tools.core_tools")
