...
from study_assistant_v1.utils import (
    parse_args,
    setup_logger,
    handle_vision_stuff,
...
def run(
    ...
    from study_assistant_v1.moves import MovementManager
    from study_assistant_v1.console import LocalStream
    from study_assistant_v1.openai_realtime import OpenaiRealtimeHandler
    from study_assistant_v1.tools.core_tools import ToolDependencies
    from study_assistant_v1.audio.head_wobbler import HeadWobbler
    ...
    if args.gradio:
        ...
        from study_assistant_v1.gradio_personality import PersonalityUI
...
class StudyAssistantV1(ReachyMiniApp):  # type: ignore[misc]
