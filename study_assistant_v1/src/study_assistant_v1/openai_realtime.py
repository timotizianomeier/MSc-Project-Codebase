...
from study_assistant_v1.config import config
from study_assistant_v1.prompts import get_session_voice, get_session_instructions
from study_assistant_v1.tools.core_tools import (
    ToolDependencies,
    get_tool_specs,
)
from study_assistant_v1.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class OpenaiRealtimeHandler(AsyncStreamHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from study_assistant_v1.config import config as _config
